...
<head>
    ...
    <title> Employee Leave Apporoval</title>
        ...
        <div class="header">
            <div class="header-content clearfix">
                ...
                <div class="text-center">
                    <h2 class="pt-3"> Employee Leave Confirmation</h2>
                </div>
...
<div class="container bg-white shadow">
    ...
    if( mysqli_num_rows($result) > 0){
        ...
        <td><?php  echo "<a href='accept_employee_leave.php?id={$id}' class='btn btn-sm btn-outline-primary mr-2'>Accept </a>" ;
                    echo "<a href='reject_employee_leave.php?id={$id}' class='btn btn-sm btn-outline-danger'>Cancel </a>" ;?>  
        </td> 
