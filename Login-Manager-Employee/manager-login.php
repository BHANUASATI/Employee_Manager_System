        ...
        if( !empty($email) && !empty($pass) ){
          ...
          if ( mysqli_num_rows($result) > 0 ){
           while( $rows = mysqli_fetch_assoc($result) ){
            ...
            header("Location: ../Manager/manager_dashboard.php?login-sucess");
           }
          }else{
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5 shadow">
                                ...
                                <p class=" login-form__footer">Not a Manager? <a href="employee-login.php" class="text-primary">Log-In </a>as Employee now</p>
                                </form>
                            </div>
                        </div>
                    </div>
